...
type TargetSign struct {
	...
	Status   uint8            `json:"status"`                                       //状态 0正常 1引起不适 2内容与话题无关 3投诉3.1辱骂攻击 3.2引战 3.3垃圾广告3.4色情低俗 3.5政治相关 3.6违法违规3.7泄露他人隐私
	Sort     uint32           `json:"-"`                                            //排序 顺序 N人举报后未审核即可降权
	User     user.UserSurface `json:"user" gorm:"foreignkey:id;references:user_id"` //用户信息
}
